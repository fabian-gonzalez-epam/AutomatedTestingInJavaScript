...
describe('Test suite', () => {
    ...
    it('Check incorrect login', async function () {
        ...
        expect(await actor('student').checkIfNoEnter()).to.equal(
    ...
    it('Add tenth board', async function () {
        ...
        */
        ...
        expect(await pages('dashboard').sideMenu.board('board10').isDisplayed())
            .to.be.true;
    });
    ...
    it('Cant add a list without name', async function () {
        ...
        expect(await pages('board').canvas.list('list1').isDisplayed()).to.be
            .false;
    });
    ...
    it('Can change profile name if it not exist', async function () {
        ...
        expect(await pages('profile').usernameForm.successLabel.isDisplayed())
            .to.be.true;
    });
    it('Cant change profile name if it already exist', async function () {
        ...
        expect(await pages('profile').usernameForm.errorLabel.isDisplayed()).to
            .be.true;
    });
});
